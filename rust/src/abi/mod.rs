...
impl ABI {
    pub fn new() -> Self {
        ...
        let uniswap_v3_factory_json = fs::read_to_string("src/abi/UniswapV3Factory.json").unwrap();
        let uniswap_v3_pair_json = fs::read_to_string("src/abi/UniswapV3Pair.json").unwrap();
        ...
        Self {
            ...
            uniswap_v3_factory: serde_json::from_str(&uniswap_v3_factory_json).unwrap(),
            uniswap_v3_pair: serde_json::from_str(&uniswap_v3_pair_json).unwrap(),
